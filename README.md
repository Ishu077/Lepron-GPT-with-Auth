...
graph TB
    ...
    subgraph "Frontend Layer - React SPA"
        ...
        StateManager[Context API State]
...
graph TB
    subgraph "React Application Structure"
        ...
        ContextProvider[MyContextProvider<br/>Global State Management]
        ...
        subgraph "API Layer"
            APIConfig[api.js<br/>Centralized API Configuration]
            APIEndpoints[API Endpoints<br/>AUTH, CHAT, THREADS]
            APIHelper[API Helper Functions<br/>apiCall, DEFAULT_FETCH_OPTIONS]
        end
...
graph TB
    subgraph "Express.js Server Architecture"
        ...
        subgraph "Middleware Stack"
            TrustProxy[Trust Proxy<br/>Production Security]
        ...
        subgraph "Authentication System"
            AuthMiddleware[auth.js<br/>Authentication Middleware]
